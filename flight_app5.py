...
Original file is located at
    https://colab.research.google.com/drive/1yAdpcrF6_w1hk0e6dNuo_ZvkmIujqDtz
"""
...
def main():
    ...
    if depart is not None:
        ...
        hour_dep = st.sidebar.selectbox("Hour", list(range(1,25)))
        minute_dep = st.sidebar.selectbox("Minute", list(range(0,61)))
    ...
    if arrival is not None:
        ...
        hour_arr = st.sidebar.selectbox("Hour:", list(range(1,25)))
        minute_arr = st.sidebar.selectbox("Minute:", list(range(0,61)))
    ...
    rfrgs_model = pickle.load(open("rfrgs.pkl","rb"))
